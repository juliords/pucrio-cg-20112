 ...
 *
 *	@param strRelation Relacao entre os objetos: uniao, intersecao ou diferenca
 *	@param obj1 Ponteiro para o primeiro objeto do conjunto
 *	@param obj2 Ponteiro para o segundo objeto do conjunto
 *
